...
<div class="row">
    ...
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            ...
            <div class="row">
            	<div class="col-md-6">
            	{{Form::open(array("route"=>"admin.location_add_post"))}}
              	<!-- Custom Tabs -->
                	...
                	<div class="tab-content">
                  		...
                  		<div class="box-body">
                    		<div class="form-group">
                    			{{Form::label("location_name_vn","Tên Địa Điểm")}}
                      			{{Form::text("location_name_vn","",array("placeholder"=>"Nhập tên địa điểm...","class"=>"form-control"))}}
                    		</div>
		                </div><!-- /.box-body -->  
                  	</div><!-- /.tab-pane -->
              		...
              		<div class="box-body">
		                ...
		                {{Form::text("slug","",array("class"=>"form-control","placeholder"=>"Nhập Slug..."))}}
		                </div>
